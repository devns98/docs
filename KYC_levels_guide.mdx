...
<Info>
  **Notes:**
  ...
  - Access levels committed on-chain via the Forte Compliance \<\> [Forte Rules Engine](https://forterulesengine.io) integration do not require any custom policy to function out-of-the-box.
...
<Card title="KYC Levels" icon="sparkles" href="/KYC_levels_guide">

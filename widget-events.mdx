...
<AccordionGroup>
  ...
  <Accordion title="FortePaymentsWidgetClosed" icon="person-to-door">
    ...
    For example, if the user closes the widget before submitting their name, this event will be fired. Cloksing the widget from any other non-terminal page in the flow will do the same.
